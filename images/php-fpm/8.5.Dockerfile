...
FROM php:8.5.0-fpm-alpine3.23

LABEL org.opencontainers.image.source="https://github.com/uselagoon/lagoon-images/blob/main/images/php-fpm/8.5.Dockerfile"
LABEL org.opencontainers.image.description="PHP 8.5 FPM image optimised for running in Lagoon in production and locally"
LABEL org.opencontainers.image.title="uselagoon/php-8.5-fpm"
LABEL org.opencontainers.image.base.name="docker.io/php:8.5-fpm-alpine3.23"
...
COPY --from=ghcr.io/php/pie:1.3.3-bin /pie /usr/local/bin/
...
ENV NEWRELIC_VERSION=12.2.0.27
